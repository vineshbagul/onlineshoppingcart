                        ...
                        <div class="myform form ">
                            ...
                            <form action="action.php" method="post" name="registration">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <input type="text" name="Alternate Contact" id="Alternate Contact" class="form-control input-sm" placeholder="Contact Number">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <input type="text" name="exp_month" id="exp_month" class="form-control input-sm" placeholder="Exp Month">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <input type="text" name="exp_year" id="exp_year" class="form-control input-sm" placeholder="Exp Year">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12 text-center ">
