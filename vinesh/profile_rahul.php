                        ...
                        <tr>
                            <td colspan="7">
                               ...
                               <!--  <button type="button" name="addaddress" onclick="addaddress()" id="" class="btn btn-info right" data-toggle="modal" data-target="#myModal">Add Address</button>
                                <button type="button" name="addcontact" onclick="addcontact()" id="" class="btn btn-secondary left" data-toggle="modal" data-target="#contactModal">Add Contact</button> -->
                            </td>
                        </tr>
                        <tr>
                            <th>ID</th>
                ...
                <table class="table table-bordered table-striped text-center">
					...
					?>
                        <tr>
                            ...
                            <td>
                             <button onclick="" class="btn btn-info edit"  data-toggle="modal" data-target="#myModal">
                                <i class="fas fa-pen editbtn"></i></button>
                             <button class="btn btn-danger" onclick=""><i class="fas fa-trash"></i></button>
                         </td>
                         </tr>  
					<?php endwhile; ?>
                    </tbody>
                ...
                <table class="table table-bordered table-striped text-center">
					...
					?>
                        <tr>
                            <td><?= $row['type_name'] ?></td>
                            <td><?= $row['phone_no'] ?></td>
                            <td> <button onclick="" class="btn btn-info edit"  data-toggle="modal" data-target="#contactModal">
                ...
                <div class="modal-dialog ">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-success" name="insertdata">Save</button>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    ...
                                    <div class="form-group">
                                        <select class="form-select form-control input-sm" id="inputGroupSelect02">
                                                                ...
                                                                <?php
                                                                // include("config.php");
                                                                $qry = "SELECT type_name FROM phonetype";
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="contactnumber" id="Alternate Contact" class="form-control input-sm" placeholder="Contact Number">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-success" data-dismiss="modal" name="contactsave">Save</button>
                            <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                        </div>
						</form>
                    </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            <select class="form-select form-control input-sm" id="inputGroupSelect02">
                                                ...
                                                <?php
                                                                // include("config.php");
                                                                $qry = "SELECT payment_type_name FROM payment_type";
                                                                $result = mysqli_query($conn,$qry);
                                                                while($row = mysqli_fetch_array($result))
                                                                {
                                ...
                                <div class="row">
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <input type="text" name="exp_month" id="exp_month" class="form-control input-sm" placeholder="Bank name">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <input type="text" name="exp_year" id="exp_year" class="form-control input-sm" placeholder="Exp date">
                                        </div>
                                    </div>
                                </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-success" data-dismiss="modal" name="paymentsave">Save</button>
                            <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                        </div>
						</form>
                    </div>
