...
$qry="SELECT * FROM `people` WHERE `email_id`='$email' AND `password`='$password'";
                        ...
                        <div class="myform form ">
                            ...
                            <form action="action.php" method="post" name="registration">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <input type="date" name="exp_date" id="exp_date" class="form-control input-sm" placeholder="Exp date">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12 text-center ">
